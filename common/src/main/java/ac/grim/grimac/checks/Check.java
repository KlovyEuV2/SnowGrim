...
public class Check extends GrimProcessor implements AbstractCheck {
    ...
    public boolean isMove(PacketTypeCommon packetTypeCommon) {
        return packetTypeCommon == PacketType.Play.Client.PLAYER_POSITION || packetTypeCommon == PacketType.Play.Client.PLAYER_POSITION_AND_ROTATION;
    }
    public boolean isExemptClick() {
        return (player.packetOrderProcessor.isClickingInInventory() || player.packetOrderProcessor.isDigging() || player.packetOrderProcessor.isPlacing());
    }
